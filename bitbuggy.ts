...
//% weight=0 color=#0fbc11  icon="\uf207" block="BitBuggy"
namespace BitBuggy {
    ...
    /**
    * TODO: initialization Bit:Buggy car
    ...
    */
    //% weight=9
    //% blockId=bitbuggy_forward block="go straight at full speed"
    ...
    */
    //% weight=8
    //% blockId=bitbuggy_back block="reverse at full speed"
    ...
    */
    //% weight=7
    //% blockId=bitbuggy_left block="turn left at full speed"
    ...
    */
    //% weight=6
    //% blockId=bitbuggy_right block="turn right at full speed"
    ...
    */
    //% weight=4
    //% blockId=bitbuggy_freestyle block="set left wheel speed %m| right wheel speed %n"
    //% m.min=-100 m.max=100
    //% n.min=-100 n.max=100
    ...
    */
    //% weight=10
    //% advanced=true
    //% blockId=bitbuggy_tracking block="tracking state is %state"
    ...
    */
    //% weight=9
    //% advanced=true
    //% blockId=bitbuggy_sonarbit block="ultrasonic distance in unit %distance_unit"
    export function bitbuggy_sonarbit(distance_unit: Distance_Unit): number {
